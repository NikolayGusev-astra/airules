...
**Для получения актуальной информации о React и связанных технологиях обязательно используй Context7:**

### Когда использовать Context7:
- ✅ Новая версия React или библиотека
- ✅ Неизвестные API или хуки
- ✅ Сложная интеграция с другими библиотеками
- ✅ Проверка совместимости версий
- ✅ Поиск лучших практик

### Примеры запросов к Context7:
```bash
# Проверить новые возможности React 18
"Show real examples of React 18 useEffect cleanup patterns"

# Найти лучшие практики для TypeScript + React
...
# Найти реальные примеры интеграции
"Show real-world examples of Zustand store with React Testing Library"
```

### Процесс использования:
1. **Сначала проверь Context7** - получи актуальную информацию
2. **Следуй проверенным паттернам** - используй реальные примеры
3. **Избегай устаревших подходов** - проверяй совместимость

**ЗАЧЕМ Context7 в React разработке:**
- ❌ Галлюцинации: устаревшие API из старых версий
- ✅ Context7: актуальные паттерны из реальных проектов
- Результат: Современный, совместимый код
